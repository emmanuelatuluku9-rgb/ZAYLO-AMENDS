...
const objectFields = {
  ...
  Shipment__c:
    "Id, Name, Order__c, Tracking_Number__c, Carrier__c, Status__c, Shipped_Date__c, CreatedDate",
  Sales_LineSC__c:
  ...
  InvoiceSC__c:
    "Id, Name, Invoice_Number__c, Amount__c, Paid_Amount__c, Due_Date__c, OrderSC__c, Status__c, CreatedDate",
  CRM_DealSC__c:
  ...
  OrderSC__c:
    "Id, Name, Order_Number__c, Account__c, Contact__c, Product_Name__c, Quantity__c, CreatedDate",
};
